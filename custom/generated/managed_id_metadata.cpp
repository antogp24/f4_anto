...
anto_normal_cursor_color = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("anto_normal_cursor_color"));
anto_visual_cursor_color = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("anto_visual_cursor_color"));
anto_insert_cursor_color = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("anto_insert_cursor_color"));
