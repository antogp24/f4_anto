...
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 2089 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1407 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1579 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1565 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1360 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1750 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1519 },
...
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1559 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1553 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1600 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 2083 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1683 },
...
{ PROC_LINKS(query_replace, 0), false, "query_replace", 13, "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1306 },
{ PROC_LINKS(query_replace_identifier, 0), false, "query_replace_identifier", 24, "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1327 },
{ PROC_LINKS(query_replace_selection, 0), false, "query_replace_selection", 23, "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1343 },
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1730 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1910 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 2007 },
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1484 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1768 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1216 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1207 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1198 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1139 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1151 },
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1758 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1451 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1133 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1145 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1708 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1858 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1936 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1696 },
