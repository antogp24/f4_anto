...
{ PROC_LINKS(basic_change_active_panel, 0), false, "basic_change_active_panel", 25, "Change the currently active panel, moving to the panel with the next highest view_id.  Will not skipe the build panel if it is open.", 132, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 668 },
...
{ PROC_LINKS(clean_all_lines, 0), false, "clean_all_lines", 15, "Removes trailing whitespace from all lines and removes all blank lines in the current buffer.", 93, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 648 },
{ PROC_LINKS(clean_trailing_whitespace, 0), false, "clean_trailing_whitespace", 25, "Removes trailing whitespace from all lines in the current buffer.", 65, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 657 },
...
{ PROC_LINKS(click_set_mark, 0), false, "click_set_mark", 14, "Sets the mark position to the mouse position.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 258 },
...
{ PROC_LINKS(close_panel, 0), false, "close_panel", 11, "Closes the currently active panel if it is not the only panel open.", 67, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 676 },
...
{ PROC_LINKS(decrease_face_size, 0), false, "decrease_face_size", 18, "Decrease the size of the face used by the current buffer.", 57, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 759 },
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 2067 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1385 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1557 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1543 },
...
{ PROC_LINKS(exit_4coder, 0), false, "exit_4coder", 11, "Attempts to close 4coder.", 25, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 848 },
...
{ PROC_LINKS(fleury_startup, 0), false, "fleury_startup", 14, "Fleury startup event", 20, "C:\\portable_apps\\4coder\\custom\\4coder_fleury\\4coder_fleury.cpp", 62, 530 },
...
{ PROC_LINKS(goto_line, 0), false, "goto_line", 9, "Queries the user for a number, and jumps the cursor to the corresponding line.", 78, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 856 },
...
{ PROC_LINKS(hide_filebar, 0), false, "hide_filebar", 12, "Sets the current view to hide it's filebar.", 43, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 706 },
{ PROC_LINKS(hide_scrollbar, 0), false, "hide_scrollbar", 14, "Sets the current view to hide it's scrollbar.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 692 },
...
{ PROC_LINKS(increase_face_size, 0), false, "increase_face_size", 18, "Increase the size of the face used by the current buffer.", 57, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 748 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1338 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1728 },
...
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1497 },
...
{ PROC_LINKS(mouse_wheel_change_face_size, 0), false, "mouse_wheel_change_face_size", 28, "Reads the state of the mouse wheel and uses it to either increase or decrease the face size.", 92, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 801 },
{ PROC_LINKS(mouse_wheel_scroll, 0), false, "mouse_wheel_scroll", 18, "Reads the scroll wheel value from the mouse state and scrolls accordingly.", 74, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 268 },
{ PROC_LINKS(move_down, 0), false, "move_down", 9, "Moves the cursor down one line.", 31, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 342 },
{ PROC_LINKS(move_down_10, 0), false, "move_down_10", 12, "Moves the cursor down ten lines.", 32, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 354 },
{ PROC_LINKS(move_down_textual, 0), false, "move_down_textual", 17, "Moves down to the next line of actual text, regardless of line wrapping.", 72, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 360 },
{ PROC_LINKS(move_down_to_blank_line, 0), false, "move_down_to_blank_line", 23, "Seeks the cursor down to the next blank line.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 413 },
{ PROC_LINKS(move_down_to_blank_line_end, 0), false, "move_down_to_blank_line_end", 27, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 437 },
{ PROC_LINKS(move_down_to_blank_line_skip_whitespace, 0), false, "move_down_to_blank_line_skip_whitespace", 39, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 425 },
{ PROC_LINKS(move_left, 0), false, "move_left", 9, "Moves the cursor one character to the left.", 43, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 443 },
{ PROC_LINKS(move_left_alpha_numeric_boundary, 0), false, "move_left_alpha_numeric_boundary", 32, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 520 },
{ PROC_LINKS(move_left_alpha_numeric_or_camel_boundary, 0), false, "move_left_alpha_numeric_or_camel_boundary", 41, "Seek left for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 106, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 534 },
{ PROC_LINKS(move_left_token_boundary, 0), false, "move_left_token_boundary", 24, "Seek left for the next beginning of a token.", 44, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 492 },
{ PROC_LINKS(move_left_whitespace_boundary, 0), false, "move_left_whitespace_boundary", 29, "Seek left for the next boundary between whitespace and non-whitespace.", 70, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 477 },
{ PROC_LINKS(move_left_whitespace_or_token_boundary, 0), false, "move_left_whitespace_or_token_boundary", 38, "Seek left for the next end of a token or boundary between whitespace and non-whitespace.", 88, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 506 },
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1537 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1531 },
{ PROC_LINKS(move_right, 0), false, "move_right", 10, "Moves the cursor one character to the right.", 44, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 451 },
{ PROC_LINKS(move_right_alpha_numeric_boundary, 0), false, "move_right_alpha_numeric_boundary", 33, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 513 },
{ PROC_LINKS(move_right_alpha_numeric_or_camel_boundary, 0), false, "move_right_alpha_numeric_or_camel_boundary", 42, "Seek right for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 107, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 527 },
{ PROC_LINKS(move_right_token_boundary, 0), false, "move_right_token_boundary", 25, "Seek right for the next end of a token.", 39, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 485 },
{ PROC_LINKS(move_right_whitespace_boundary, 0), false, "move_right_whitespace_boundary", 30, "Seek right for the next boundary between whitespace and non-whitespace.", 71, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 469 },
{ PROC_LINKS(move_right_whitespace_or_token_boundary, 0), false, "move_right_whitespace_or_token_boundary", 39, "Seek right for the next end of a token or boundary between whitespace and non-whitespace.", 89, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 499 },
{ PROC_LINKS(move_up, 0), false, "move_up", 7, "Moves the cursor up one line.", 29, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 336 },
{ PROC_LINKS(move_up_10, 0), false, "move_up_10", 10, "Moves the cursor up ten lines.", 30, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 348 },
{ PROC_LINKS(move_up_to_blank_line, 0), false, "move_up_to_blank_line", 21, "Seeks the cursor up to the next blank line.", 43, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 407 },
{ PROC_LINKS(move_up_to_blank_line_end, 0), false, "move_up_to_blank_line_end", 25, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 431 },
{ PROC_LINKS(move_up_to_blank_line_skip_whitespace, 0), false, "move_up_to_blank_line_skip_whitespace", 37, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 419 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1578 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 2061 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1661 },
...
{ PROC_LINKS(page_down, 0), false, "page_down", 9, "Scrolls the view down one view height and moves the cursor down one view height.", 80, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 378 },
{ PROC_LINKS(page_up, 0), false, "page_up", 7, "Scrolls the view up one view height and moves the cursor up one view height.", 76, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 370 },
...
{ PROC_LINKS(query_replace, 0), false, "query_replace", 13, "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1284 },
{ PROC_LINKS(query_replace_identifier, 0), false, "query_replace_identifier", 24, "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1305 },
{ PROC_LINKS(query_replace_selection, 0), false, "query_replace_selection", 23, "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1321 },
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1708 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1888 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1985 },
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1462 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1746 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1194 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1185 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1176 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1117 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1129 },
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1736 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1429 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1111 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1123 },
...
{ PROC_LINKS(select_all, 0), false, "select_all", 10, "Puts the cursor at the top of the file, and the mark at the bottom of the file.", 79, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 543 },
...
{ PROC_LINKS(set_face_size, 0), false, "set_face_size", 13, "Set face size of the face used by the current buffer.", 53, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 728 },
{ PROC_LINKS(set_face_size_this_buffer, 0), false, "set_face_size_this_buffer", 25, "Set face size of the face used by the current buffer; if any other buffers are using the same face a new face is created so that only this buffer is effected", 157, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 770 },
...
{ PROC_LINKS(show_filebar, 0), false, "show_filebar", 12, "Sets the current view to show it's filebar.", 43, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 699 },
{ PROC_LINKS(show_scrollbar, 0), false, "show_scrollbar", 14, "Sets the current view to show it's scrollbar.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 685 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1686 },
...
{ PROC_LINKS(to_lowercase, 0), false, "to_lowercase", 12, "Converts all ascii text in the range between the cursor and the mark to lowercase.", 82, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 569 },
{ PROC_LINKS(to_uppercase, 0), false, "to_uppercase", 12, "Converts all ascii text in the range between the cursor and the mark to uppercase.", 82, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 556 },
...
{ PROC_LINKS(toggle_filebar, 0), false, "toggle_filebar", 14, "Toggles the visibility status of the current view's filebar.", 60, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 713 },
{ PROC_LINKS(toggle_fps_meter, 0), false, "toggle_fps_meter", 16, "Toggles the visibility of the FPS performance meter", 51, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 722 },
...
{ PROC_LINKS(toggle_line_numbers, 0), false, "toggle_line_numbers", 19, "Toggles the left margin line numbers.", 37, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 827 },
{ PROC_LINKS(toggle_line_wrap, 0), false, "toggle_line_wrap", 16, "Toggles the line wrap setting on this buffer.", 45, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 835 },
...
{ PROC_LINKS(toggle_show_whitespace, 0), false, "toggle_show_whitespace", 22, "Toggles the current buffer's whitespace visibility status.", 58, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 818 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1836 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1914 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "C:\\portable_apps\\4coder\\custom\\4coder_base_commands.cpp", 55, 1674 },
