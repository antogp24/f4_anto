...
////////////////////////////////
#include "4coder_fleury/anto/anto_modal.h"
...
CUSTOM_DOC("Interactively switch to an open buffer.")
{
    ...
    if (buffer != 0){
        ...
        //~ NOTE(anto): After switching buffers
...
CUSTOM_DOC("Opens an interactive list of all registered themes.")
{
    ...
    //~ NOTE(anto): Change the cursor modes colors if they exist
    
    if (color_table != 0){
        active_color_table = *color_table;
        
#include "4coder_fleury/anto/anto_modes_theme.cpp"
        go_to_normal_mode( app );
    }
